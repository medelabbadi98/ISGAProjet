                        ...
                        <input type="text" name="ID" value="{{$ID}}" hidden>    
                            <div class="row">
                                <div class="form-group col-12 col-md-6">
                                    <input type="text" class="input form-control" name="Intitule_Poste" autocomplete="on" placeholder="Poste" required="required" value="{{$Intpost}}" >
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="date" class="input form-control" name="Date_Debut" required="required" value="{{$dateDeb}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                                ...
                                <div class="form-group col-12 col-md-12">
                                    <textarea class="textarea form-control" name="Description_Ex" placeholder="Description" rows="4" required="required" tabindex="1" style="overflow: hidden; overflow-wrap: break-word; height: 118px; outline: none;">{{$Desc}}</textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
