            ...
            <div class="row sticky-parent ">
                ...
                <aside class="col-12 col-md-12 col-xl-3">
				    <div class="sidebar box shadow pb-5 sticky-column" style="z-index: 1;">
                        ...
                        <form id="contact-form" method="POST" action="{{ route('ChercherOffre',[0]) }}" class="contact-form">
                        @csrf
                            <div class="input-group">
                                <input class="form-control" type="text" name="keyword" value="" placeholder="Intitulé du poste">
                        ...
                        <div class="list-group mt-5">
                            ...
                            <ul class="list-group list-group-flush">
                                @foreach($secteurs as $sec)
                                    <li class="list-group-item"><a href="{{ route('ChercherOffre',[$sec->Id_Sec]) }}" >{{$sec->Nom_Sec}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="pb-0 box-inner">
                            <div class="row">
                                ...
                                <div class="case-item box box__second">
                                    ...
                                    <div>
                                        <a href="{{ route('offre-page',[$offre->Id_Offre]) }}"><h3 class="title title--tone">{{$offre->Intitule}}</h3></a>
