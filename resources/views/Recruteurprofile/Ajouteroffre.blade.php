            ...
            <div class="row">
                <div class="col-12 col-md-12 col-xl-12">
                    <div class="box shadow">
                        ...
                        @else
                            <h1 class="title title--h1 first-title title__separate">Modifier Offre</h1>
                        @endif
                        ...
                        @csrf
                            ...
                            @else
                                <div class="form-group col-12 col-md-6">
                                    <label for="offre" class="form_label">Offre :</label>
                                    <input type="text" class="input form-control" autocomplete="on" name="Intitule" placeholder="Intitule" value="{{$offre->Intitule}}" required="required" >
                                    <div class="help-block with-errors"></div>
                            ...
                            @else
                                <div class="form-group col-12 col-md-6">
                                    <label for="secteur" class="form_label">Secteurs :</label>
									<select class="input " name="secteur"  required="required">
                                    <option value="{{$selectSecteur->Id_Sec}}">{{$selectSecteur->Nom_Sec}}</option>
									@foreach($secteurs as $sec)
										<option value="{{$sec->Id_Sec}}">{{$sec->Nom_Sec}}</option>
									@endforeach
									</select>
